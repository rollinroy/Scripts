...
RSYNC_CMD="rsync -av --exclude .DS_Store --exclude .Trashes --exclude .fseventsd --exclude .Temporary* --exclude .Spotlight* --exclude .meta*  --exclude .Document* ${RSYNC_N} $srcFolder $imageMountName"
echo "$RSYNC_CMD"
time eval "$RSYNC_CMD"
